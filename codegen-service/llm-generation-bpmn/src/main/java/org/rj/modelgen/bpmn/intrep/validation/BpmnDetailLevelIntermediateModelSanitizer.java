...
public class BpmnDetailLevelIntermediateModelSanitizer extends IntermediateModelSanitizer<BpmnIntermediateModel> {
    public BpmnDetailLevelIntermediateModelSanitizer() {
