...
public abstract class IntermediateModelSubproblemDecompositionBaseState<TIntermediateModel extends IntermediateModel> extends BasicNode {
    private boolean subproblemDecompositionEnabled = true;

    public IntermediateModelSubproblemDecompositionBaseState() {
        this(IntermediateModelSubproblemDecompositionBaseState.class);
    }

    public IntermediateModelSubproblemDecompositionBaseState(Class<? extends ModelInterfaceState> cls) {
        super(cls);
    }
    ...
    public IntermediateModelSubproblemDecompositionBaseState<TIntermediateModel> withSubproblemDecompositionEnabled(boolean subproblemDecompositionEnabled) {
